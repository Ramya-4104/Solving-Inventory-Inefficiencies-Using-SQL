...
How to Run
Open MySQL Workbench → connect to local instance (default: root, port 3306)
Open C&A_PROJECT.sql via File → Open SQL Script
Run Section 1 to create the database
Run Section 2 to create inventory_rawdata
Right-click inventory_rawdata in the left panel → Table Data Import Wizard → import the Excel/CSV file
Run Sections 3 through 10 in order — each section builds on the previous one
